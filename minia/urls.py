...
urlpatterns = [
    ...
    # 여기부터 개발 앱
    path('dtCommunity/',include('dtCommunity.urls')), #
    path('dtapp/', include('dtapp.urls')),

]

urlpatterns += static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT) # 미디어 파일의 요청이 들어오면 MEDIA_ROOT에 있는 MEDIA 파일을 돌려줌